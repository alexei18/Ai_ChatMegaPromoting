      ...
      <div className="relative mx-auto w-full max-w-7xl z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-10">
          <div className="md:col-span-6 lg:col-span-5 xl:col-span-5">
            ...
            >
              <span className="text-[11px] font-medium tracking-wide text-gray-700"></span>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center rounded-full bg-black/5 px-3 py-1 text-xs text-gray-700"></span>
              <span className="inline-flex items-center rounded-full bg-black/5 px-3 py-1 text-xs text-gray-700"></span>
              <span className="inline-flex items-center rounded-full bg-black/5 px-3 py-1 text-xs text-gray-700"></span>
            </div>
            {/* Auth buttons */}
